...
//            }
            ...
            Log.d("data.title", ">>>>>>>>>>${data?.postTitle}") // null
            Log.d("data.date", ">>>>>>>>>>${data?.postDate}") // null
            Log.d("data.content", ">>>>>>>>>>${data?.postContent}") // null

//            Log.d("checkData1", ">>>>>>>>>>$data") // null
